        ...
        describe("configures android tasks for android application") {
            ...
            it("task :app:detektMain") {
                gradleRunner.runTasksAndCheckResult(":app:detektMain") { buildResult ->
                    assertThat(buildResult.output).containsPattern("--baseline [^ ]*/baseline-release.xml ")
                    assertThat(buildResult.output).containsPattern("--baseline [^ ]*/baseline-debug.xml ")
            ...
            it("task :app:detektTest") {
                gradleRunner.runTasksAndCheckResult(":app:detektTest") { buildResult ->
                    assertThat(buildResult.output).containsPattern("--baseline [^ ]*/baseline-releaseUnitTest.xml ")
                    assertThat(buildResult.output).containsPattern("--baseline [^ ]*/baseline-debugUnitTest.xml ")
                    assertThat(buildResult.output).containsPattern("--baseline [^ ]*/baseline-debugAndroidTest.xml ")
                    assertThat(buildResult.output).contains("--report xml:")
                    assertThat(buildResult.output).contains("--report sarif:")
                    assertThat(buildResult.output).doesNotContain("--report txt:")
                    assertThat(buildResult.tasks.map { it.path }).containsAll(
            ...
            it("task :app:check") {
                gradleRunner.runTasksAndCheckResult(":app:check") { buildResult ->
                    assertThat(buildResult.output).containsPattern("--baseline [^ ]*/baseline.xml ")
